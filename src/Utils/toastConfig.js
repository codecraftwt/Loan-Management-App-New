...
export const toastConfig = {
    success: ({ text1, text2 }) => (
        <View style={{ padding: 15, backgroundColor: 'green', borderRadius: 10, width: 350, }}>
            <Text style={{ color: 'white', fontWeight: 'bold' }}>{text1}</Text>
            {/* <Text style={{ color: 'lightgray' }}>{text2}</Text> */}
        </View>
    ),
    error: ({ text1, text2 }) => (
        <View style={{ padding: 15, backgroundColor: 'red', borderRadius: 10, width: 350 }}>
            <Text style={{ color: 'white', fontWeight: 'bold' }}>{text1}</Text>
            {/* <Text style={{ color: 'lightgray' }}>{text2}</Text> */}
        </View>
    ),
    info: ({ text1, text2 }) => (
        <View style={{ padding: 15, backgroundColor: '#3842ff', borderRadius: 10, width: 350 }}>
            <Text style={{ color: 'white', fontWeight: 'bold' }}>{text1}</Text>
            {/* <Text style={{ color: 'lightgray' }}>{text2}</Text> */}
        </View>
    ),
